...
router.post('/download/:videoId', authenticateToken, asyncHandler(async (req, res) => {
...
router.get('/download/:downloadId/progress', authenticateToken, asyncHandler(async (req, res) => {
...
router.get('/downloads', authenticateToken, asyncHandler(async (req, res) => {
